package com.future.eshop.config.database;
...
@EnableJpaRepositories(basePackages = "com.future.eshop.repository", entityManagerFactoryRef = "entityManagerFactoryBean")
public class HibernateConfig {

    private static final String ENTITY_PACKAGE = "com.future.eshop.domain";
